...
//                         // ── 9. Attach k6-console.log to the Jira ticket ──────
//                         def issueKey = respJson.key
//                         bat """
//                             curl -s -o jira-attach-response.json ^
//                                  -X POST ^
...
//                                  "${env.JIRA_BASE_URL}/rest/api/2/issue/${issueKey}/attachments"
//                         """
//                         echo "📎 Build log attached to ${issueKey} — team can download it from the Jira ticket"
//                     } else {
//                         echo "⚠️ Jira API returned: ${httpStatus}"
//                         echo "Response: ${jiraResp}"
//                     }
...
//--------Additional Iteration without Jira Integration (for reference)--------//
// pipeline {
//     agent any
